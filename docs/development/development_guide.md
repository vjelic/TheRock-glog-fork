...
If building with the in-tree HIP compiler, `CMAKE_C_COMPILER`, `CMAKE_CXX_COMPILER`, `CMAKE_LINKER`, `AMDGPU_TARGETS, `GPU_TARGETS`and`CMAKE_CXX_FLAGS_INIT\` will be set accordingly.
